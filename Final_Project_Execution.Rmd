...
satire_corpus <- corpus(myfiles) # create the corpus

mydfm <- dfm(satire_corpus, ignoredFeatures = stopwords("english"), stem=TRUE) # dfm automatically applies toLower and removes punctuation
